...
const containerElement = document.getElementById("testimonial-containers");
...
const updatePage = () => {
  ...
  if (testimonials.length > 1) {
    markUp += `<nav><button onclick="prevTestimonial()">Previous</button>
    <button onclick="nextTestimonial()">Next</button></nav>
    `;
  }
